...
**[⬇️ Download Latest Release (v0.3.4)](https://github.com/encomjp/razer-control-revived/releases/tag/v0.3.4)**
...
```bash
sudo dnf install ./razercontrol-0.3.4-1.fc43.x86_64.rpm
```
...
# 2. Run the AppImage
chmod +x RazerControl-0.3.4-x86_64.AppImage
./RazerControl-0.3.4-x86_64.AppImage
```
