...
**[⬇️ Download Latest Release (v0.3.1)](https://github.com/encomjp/razer-control-revived/releases/tag/v0.3.1)**
...
```bash
sudo dnf install ./razercontrol-0.3.1-1.fc43.x86_64.rpm
```
...
tar -xzf razer-control-0.3.1-x86_64.tar.gz
cd razer-control-0.3.1-x86_64
sudo ./install.sh

# 2. Run the AppImage
chmod +x RazerControl-0.3.1-x86_64.AppImage
./RazerControl-0.3.1-x86_64.AppImage
```
